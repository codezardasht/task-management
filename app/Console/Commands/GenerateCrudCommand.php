...
//        $this->call('technobase:migration', ['name' => $migrationName, '--schema' => $fields, '--pk' => $primaryKey, '--indexes' => $indexes, '--foreign-keys' => $foreignKeys]);
    ...
    {
        $array = [
            "Route::get('/$this->routeName/status_change/{$this->routeName}', [$this->controller::class, 'status_change'])->name('$this->routeName.status_change');",
            "Route::get('/$this->routeName/data', [$this->controller::class, 'data'])->name('$this->routeName.data');",
            "Route::resource('" . $this->routeName . "', $this->controller::class);"
        ];
        return $array;
    }
